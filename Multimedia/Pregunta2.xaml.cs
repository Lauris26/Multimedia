...
namespace Multimedia
{
    ...
    /// </summary>
    public sealed partial class Pregunta2 : Page
    {
        public Pregunta2()
        {
        ...
        private void cambioLabels(ResourceManager testresource)
        {
            ...
            opcion1Fallo.Content = testresource.GetString("String5");
            opcion2Fallo.Content = testresource.GetString("String6");
            opcion3Fallo.Content = testresource.GetString("String7");
            opcion4Fallo.Content = testresource.GetString("String8");
            opcion1Correcta.Content = testresource.GetString("String5");
            opcion2Correcta.Content = testresource.GetString("String6");
            opcion3Correcta.Content = testresource.GetString("String7");
            opcion4Correcta.Content = testresource.GetString("String8");
